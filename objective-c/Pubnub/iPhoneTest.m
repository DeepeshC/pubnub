...
- (void)viewDidLoad
{
    ...
    pubnub = [[CEPubnub alloc] initWithPublishKey:@"pub-75a3aad0-d9c8-4763-8838-9aae1226ed0c" subscribeKey:@"sub-fdd15440-8939-11e1-aa2b-41374c390533" secretKey:@""   useSSL:NO];//(Cipher key is Optional)
